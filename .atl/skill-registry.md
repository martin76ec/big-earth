...
### branch-pr
- Path: /home/martin/.config/opencode/skills/branch-pr/SKILL.md
...
### chained-pr
- Path: /home/martin/.config/opencode/skills/chained-pr/SKILL.md
...
- Path: /home/martin/.config/opencode/skills/cognitive-doc-design/SKILL.md
...
### comment-writer
- Path: /home/martin/.config/opencode/skills/comment-writer/SKILL.md
...
### docmancer
- Path: /home/martin/.agents/skills/docmancer/SKILL.md
- Trigger: Search local documentation context packs with docmancer CLI. Use when the user asks about library docs, API references, vendor docs, version-specific behavior, offline docs, or wants to add docs before answering a technical question.
- Rules:
...
### go-testing
- Path: /home/martin/.config/opencode/skills/go-testing/SKILL.md
...
### imagegen
- Path: /home/martin/.codex/skills/.system/imagegen/SKILL.md
...
### issue-creation
- Path: /home/martin/.config/opencode/skills/issue-creation/SKILL.md
...
### judgment-day
- Path: /home/martin/.config/opencode/skills/judgment-day/SKILL.md
...
### openai-docs
- Path: /home/martin/.codex/skills/.system/openai-docs/SKILL.md
- Trigger: Use when the user asks how to build with OpenAI products or APIs and needs up-to-date official documentation with citations, help choosing the latest model for a use case, or model upgrade and prompt-upgrade guidance; prioritize OpenAI docs MCP tools, use bundled references only as helper context, and restrict any fallback browsing to official OpenAI domains.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### plugin-creator
- Path: /home/martin/.codex/skills/.system/plugin-creator/SKILL.md
...
### skill-creator
- Path: /home/martin/.config/opencode/skills/skill-creator/SKILL.md
...
### skill-installer
- Path: /home/martin/.codex/skills/.system/skill-installer/SKILL.md
...
### work-unit-commits
- Path: /home/martin/.config/opencode/skills/work-unit-commits/SKILL.md
